...
See <<{application-prefix}org.codice.alliance.catalog.plugin.defaultsecurity.DefaultSecurityAttributeValuesPlugin,Default Security Attribute Plugin configurations>> for all possible configurations.
