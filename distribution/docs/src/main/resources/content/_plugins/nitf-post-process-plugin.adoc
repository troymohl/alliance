...
The NITF Post-Process Plugin is an experimental replacement for the <<{application-prefix}NITF_Render_Plugin,NITF Render Plugin>> that creates and stores the NITF thumbnail and NITF overview images.
...
See <<{application-prefix}NITF_Post_Process_Plugin,NITF Post-Process Plugin configurations>> for all possible configurations.
