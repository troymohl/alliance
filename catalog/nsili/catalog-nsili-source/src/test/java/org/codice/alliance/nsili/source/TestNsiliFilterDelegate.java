...
public class TestNsiliFilterDelegate {
    ...
    @Before
    public void setUp() {
        filterDelegate = new NsiliFilterDelegate(generateAttributeInformation(),
    ...
    public void testPropertyLikeNullQueryableAttributes() {
        NsiliFilterDelegate filterDelegate = new NsiliFilterDelegate(null,
                NsiliConstants.NSIL_ALL_VIEW);
        String filter = filterDelegate.propertyIsLike(ANY_TEXT, ATTRIBUTE, false);
    ...
    public void testPropertyLikeNullQueryableAttributesForView() {
        ...
        NsiliFilterDelegate filterDelegate = new NsiliFilterDelegate(map,
                NsiliConstants.NSIL_ALL_VIEW);
        String filter = filterDelegate.propertyIsLike(ANY_TEXT, ATTRIBUTE, false);
        assertThat(filter, is(NsiliFilterDelegate.EMPTY_STRING));
    }
