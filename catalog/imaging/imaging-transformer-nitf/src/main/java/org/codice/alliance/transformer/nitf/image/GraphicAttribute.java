...
public enum GraphicAttribute implements NitfAttribute<GraphicSegment> {
  ...
  GRAPHIC_CODEWORDS(
      "graphic-codewords", "SSCODE", segment -> segment.getSecurityMetadata().getCodewords()),
  ...
  GRAPHIC_DOWNGRADE(
      "graphic-downgrade", "SSDG", segment -> segment.getSecurityMetadata().getDowngrade()),
  ...
  GRAPHIC_COLOR("graphic-color", "SCOLOR", segment -> segment.getGraphicColour().toString()),
